...
//--
//template < class T >
// void BSTree < T >::removeRoot(const T& d, Node* temp)
// {
//     temp = root;
//     Node* temp2 = 
//     if (root->data == d)
...
//--
// template < class T >
// void BSTree < T >::removeHelper(const T& d)
// {
// }
//--
// template < class T >
// auto* BSTree < T >::leftMostRightSide()
// {
//     monkey = root->right;
//     n = 0;
// }
//--
template < class T >
auto* BSTree < T >::leftMostRightSideHelper(int n)
{

}
// //--
// template < class T >
// auto* BSTree < T >::previous(Node* p)
// {
